...
class CheckersRL:
    ...
    def compute_intermediate_reward(self, prev_state: list, new_state: list, action: list[tuple]) -> float:
        ...
        reward += 7.5*(new_advantage - prev_advantage)
        ...
        reward += 20*(new_capture - prev_capture)
        ...
        reward += 0.1*new_back_count - 0.1*(prev_back_count - new_back_count)
        ...
        reward += 25*(new_center - prev_center)
        ...
        reward += 25*(new_kcenter - prev_kcenter)
